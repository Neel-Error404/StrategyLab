# Backtester/strategies/support/strategy_factory.py
...
class StrategyFactory:
    ...
    def register_strategy(cls, name: str, strategy_class):
        ...
        Args:
            name: Strategy name (e.g., 'mse', 'strategy_mac')
    ...
    def clear_registry(cls):
        ...
        # Built-in strategies will be registered via support/register_strategies.py
