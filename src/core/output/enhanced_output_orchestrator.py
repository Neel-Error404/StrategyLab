...
class EnhancedOutputOrchestrator:
    ...
    def process_complete_backtest_results(self,
                                          ...
                                          strategy_run_dir: Optional[Path] = None,
        ...
        try:
            ...
            # 5. Generate all visualizations (skip if requested for speed)
            if not skip_visualization:
                ...
                self.logger.info("⏭️  Skipping visualization generation (--skip-visualization flag)")
                processing_results['visualizations'] = {'skipped': True, 'reason': 'skip_visualization flag set'}
